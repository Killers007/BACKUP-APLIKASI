            ...
            <header class="header bg-white b-b b-light">
                <section class="row m-b-md" style="">
                    ...
                    <div class="col-xs-4 m-t-md pull-right">
                        <a target="_blank" href="<?php echo base_url($modul . '/detail_ringkasan/xls'); ?>" class="pull-right btn btn-default btn_add btn-primary"><i class="fa fa-file-excel-o"></i> <span class="hidden-xs hidden-sm hidden-md">Download Excel</span></a>
                        <a target="_blank" href="<?php echo base_url($modul . '/detail_ringkasan/pdf'); ?>" class="pull-right btn btn-default btn_add btn-primary" data-target="modal_cetak"><i class="fa  fa-print"></i> <span class="hidden-xs hidden-sm hidden-md">Cetak PDF</span></a>
                    ...
                    <table id="table-bagian" class="table table-hover table-bordered" style="margin-top: -500px" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr class="font-bold">
                                ...
                                <td style="vertical-align: middle" width="20%">No Registrasi</td>
                                <td style="vertical-align: middle">Nama Mahasiswa</td>
                                <td style="vertical-align: middle" width="20%">Rincian Masalah</td>
                                <td style="vertical-align: middle" width="20%">Program Studi</td>
                            </tr>
                        </thead>
                        <tbody>
...
<script>
    $(document).ready(function() {
        oTable = $('#table-bagian').dataTable({
            "ajax": {
                "url": '<?php echo base_url($modul . '/detail_ringkasan_request') ?>',
                "type": "POST",
                "data": {}
            },
            processing: true,
