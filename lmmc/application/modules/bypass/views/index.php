            ...
            <header class="header bg-white b-b b-light">
                <section class="row m-b-md" style="">
                    <div class="col-xs-6 col-md-6 col-lg-6">
                        ...
                        ?>
                        <h1 class="m-b-xs text-black hidden-xs"><small><span class="m-b-xs text-black">Bypass | </span> <span style="font-size: 13px"><?php echo $text ?></span></small></h1>
                    ...
                    <div class="col-xs-6 col-md-6 col-lg-6 m-t-lg pull-right">
                       ...
                       <a  onclick="setTitle('Tambah', 'Tambah')" data-toggle="modal" data-target="#modal-edit" class="btnShowModal btn btn-primary pull-right" style="margin-right:5px"><i class="fa  fa-plus"></i> <span class="hidden-xs">Bypass Tagihan</span></a>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Bypass Tagihan</h4>
            </div>
            ...
            pTable = $('#tablePreview').dataTable({
                ...
                },
                {
                    data: 'bypassNoRegis', render: function (data, type, row, meta) {
                        ...
                        return row.bypassNoRegis+availabe+lunas;
                    }
                },
                {data: 'tagihanNama'},
                {data: 'tagihanProdi'},
