            ...
            <header class="header bg-white b-b b-light">
                <section class="row m-b-md" style="">
                    <div class="col-xs-9">
                        ...
                        $text = 'Master';
                        ?>
                        <h1 class="m-b-xs text-black hidden-xs"><small><b>Dokter | </b><span style="font-size: 13px"><?php echo ucwords(strtolower($text)); ?></span></small></h1>
                ...
                <table id="table" width="100%" class="table table-hover table-bordered" style="margin-top: -500px"  cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle" width="10%">Opsi</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-footer" style="margin-right: -50px">
                ...
                <button type="submit" class="btn btn-success btnSimpan"><!-- <span class="modalSimpan"></span> --><span class="hidden-xs"><span class="fa  fa-save"></span> Simpan</span></button>
            </div>
        </form>
        </div>
    </div>
