	...
	<?php foreach ($datas as $key => $data): ?>
			...
			<table class='header' width="100%">
				...
				<table style="width: 100%; font-size: small;" >
					<tr>
						<td  align='left' style="font-weight:bold;">Program Studi : <?php echo ucwords(strtolower(@$data['fakultas']->prodiJjarKode)) ?> - <?php echo ucwords(strtolower(@$data['fakultas']->prodiNamaResmi)) ?></td>
					</tr>
				</table>
