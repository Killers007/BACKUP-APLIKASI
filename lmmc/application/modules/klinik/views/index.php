...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function _initialDatatable()
        {
            ...
            columns: [
            {
                data: 'klinikId', render: function (data, type, row, meta) {
            ...
            {data: 'klinikFormnama'},
            {
                data: 'klinikHasil', render: function (data, type, row, meta) {
        ...
        $(document).on('click', '.btnHasilAdd', function(event) {
            ...
            var _tempText = `<tr id="`+_uuid+`">
                                <td>`+text+`<input type="hidden" name="hasil[`+_uuid+`][value]" value="`+text+`"></td>
            ...
            $.ajax({
                ...
                success: function(res)
                {
                    ...
                    $.each(res, function(index, val) {
                        ...
                        text += `<tr id="`+_uuid+`">
                                    <td>`+val.knkdtNamahasil+`<input type="hidden" name="hasil[`+_uuid+`][value]" value="`+val.knkdtNamahasil+`"><input type="hidden" name="hasil[`+_uuid+`][id]" value="`+val.knkdtId+`"></td>
                                    <td class="text-right">
                                        <a href="#`+_uuid+`" data-dismiss="alert"><i style='color : #e33244' class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>`;
