            ...
            <header class="header bg-white b-b b-light">
                <section class="row m-b-md" style="">
                    <div class="col-xs-9">
                        ...
                        $text = 'Master';
                        ?>
                        <h1 class="m-b-xs text-black hidden-xs"><small><span class="text-black">Modul | </span><span style="font-size: 13px"><?php echo ucwords(strtolower($text)); ?></span></small></h1>
                ...
                <table id="table" width="100%" class="table table-hover table-bordered" style="margin-top: -500px"  cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: middle">Nama Modul</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#table').dataTable({
            ...
            columnDefs: [{"className": "dt-tengah", "targets": [0,2]}],
            order: [[0, "asc"], [1, "desc"]],
            'searching'   : true,
            pagingType: 'numbers',
            language:{
            ...
            columns: [
            {
                data: 'modul', render: function (data, type, row, meta) {
            ...
            {data: 'modul'},
            {
                data: null, searchable: false, orderable: false, render: function (data) {
                    ...
                    var btnUbah =  `&nbsp;<a onclick="setTitle('Perbaharui', 'Perbaharui')" data-id="`+data.modul+`" class="btnEdit btn btn-xs btn-default" title="View">
                    <i style="color: #1aabbb;"class="i i-pencil2"></i>
                    </a>` ;

                    var btnHapus = `<a class="btn btn-xs btn-default btnDelete" data-toggle="tooltip" data-id='`+data.modul+`' data-nama='`+data.modul+`' data-backdrop='static' data-toggle='modal' data-target='#modal-hapus' title='Hapus'><span style='color : #e33244' class='i i-trashcan'></span></a> `;
                    
                    var btnDetail = `&nbsp;<a class="btn btn-xs btn-default btnDetail" data-toggle="tooltip" data-toggle='modal' data-id='`+data.modul+`' data-target='#modal-detail' title='Detail'><span style='color : #177bbb' class='fa fa-search'></span></a> `;
        ...
        $(document).on('click', '.btnEdit', function(event) {
            ...
            find = dataFull.find(seep => seep.modul == id);
