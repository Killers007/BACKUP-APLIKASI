                                    ...
                                    <section class="vbox">
                                        <header class="header bg-white b-b b-light">
                                            <section class="row m-b-md" style="">
                                                <div class="col-xs-8">
                                                    <h1 class="m-b-xs text-black hidden-xs"><small>Pemeriksaan<span style="font-size: 12px"></span></small></h1>
                                                </div>
...
<script>
    ...
    function updHasil() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>pemeriksaan/update_hasil",
            type: "POST",
            ...
            success: function(data) {
                ...
                if (data.status == "validasi") {
                    ...
                    $('[name=inVal]').removeClass();
                    $('[id=hasilBarcode-v]').addClass('alert alert-success').html('Data pemeriksaan berhasil disimpan');
    ...
    function btnSimpan() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>pemeriksaan/request_barcode",
            type: "POST",
