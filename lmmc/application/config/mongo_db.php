...
$config['mongo_db']['default']['hostname'] = '10.64.1.50';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'dblog';
$config['mongo_db']['default']['password'] = 'log3264';
$config['mongo_db']['default']['database'] = 'db_log';
